...
if (isset($_REQUEST['poid'])) {
	...
	$poid = mysqli_real_escape_string($connection,$_REQUEST['poid']);
}else {
...
$getposts = mysqli_query($connection,"SELECT * FROM products WHERE id ='$poid'") or die(mysqli_error());
...
//triming name
	try {
		...
		// Check if email already exists
						...
						if(mysqli_query($connection,"INSERT INTO orders (uid,pid,quantity,oplace,mobile,odate,ddate) VALUES ('$user','$poid',$quan,'$_POST[address]','$_POST[mobile]','$d','$date')")){
	...
	<div class="categolis">
		<table>
			<tr>
				...
				<th><a href="farm/watch.php" style="text-decoration: none;color: #ddd;padding: 4px 12px;background-color: #4CAF50;border-radius: 12px;">Watch</a></th>
