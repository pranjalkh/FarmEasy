...
$_POST['last_name'] = trim($_POST['last_name']);
	try {
		...
		$check = 0;
		$e_check = mysqli_query($connection,"SELECT email FROM `admin` WHERE email='$u_email'");
		...
		<div class="categolis">
			<table>
				<tr>
					...
					<th><a href="addproduct.php" style="text-decoration: none;color: #ddd;padding: 4px 12px;background-color: #4CAF50;border-radius: 12px;">Add Product</a></th>
